	...
	var a = 0;
  	function loadCategories(){
        ...
        for(var i = 0; i < categories.length; i++){
          ...
          if(categories[i].id == {{$item->categoria}})
  	...
  	function updateSubCats(){
        ...
        for(var i = 0; i < subcats[catid].length; i++){
          ...
          if(subcats[catid][i].id == {{$item->subcategoria}})
  	...
  	function updateTypes(){
        ...
        for(var j = 0; j < grupos[catid][subcatid].length; j++){
	        ...
	        for(var i = 0; i < types[catid][subcatid][grupoid].length; i++){
				...
				if(relacoes != null){
					for(var x = 0; x < relacoes.length; x++){
						if(checkbox.id == relacoes[x].val){
	        ...
	        <div class="col-md-8 col-md-offset-2">
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	    				<form action="{{route('storeEdit', $item)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        	{{csrf_field()}}
							    ...
							    <div class="col-md-6">
								    <div class="input-group">
								    	<input pattern=".{2,45}" type="text" class="form-control" name="nome" id="inputNome"
								           value="{{old('nome', $item->nome)}}" required title="nome entre 2 e 45 caracteres" autofocus>
					            	</div>
							    </div>
							</div>
                        	<div class="form-group">
							...
							<div class="form-group" id="form-preco">
							    ...
							    <div class="col-md-6">
								    <div class="input-group">
								    	<input type="number" class="form-control" name="preco" id="inputPreco" min="1" max="20000" value="{{old('preco', $item->preco)}}" required>
	                            ...
	                            <div class="col-md-6">
	                                ...
	                                <output id="list">
	                               	@foreach($item->fotos as $foto)
	                                	<img class="thumb" src="{{asset('/storage/fotos/'.$foto->foto)}}">
	                                @endforeach
	                                </output>
        							<script>
