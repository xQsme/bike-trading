                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" pattern=".{2,22}" type="text" class="form-control" name="name" value="{{ old('name') }}" required title="nome entre 2 e 22 caracteres" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="username" pattern=".{2,22}" type="text" class="form-control" name="username" value="{{ old('username') }}" required title="username entre 2 e 22 caracteres" autofocus>
